// 注: process.env.XX是Vercel的环境变量，配置方式见：https://bukeba.com/article/how-to-config-notion-next#c4768010ae7d44609b744e79e2f9959a
...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'NotionNext', // 您的昵称 例如 bukeba
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://bukeba.com', // 网站地址
