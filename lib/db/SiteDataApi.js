    ...
    allPages: [
      {
        ...
        summary:
          '访问文档获取帮助 → https://bukeba.com/article/vercel-deploy-notion-next',
        status: 'Published',
        type: 'Post',
        slug: 'oops',
        publishDay: '2024-11-13',
        pageCoverThumbnail: BLOG.HOME_BANNER_IMAGE || 'https://img.ipoodle.top/file/isharehubs/1770190724936_banner.png',
        date: {
...
function getSiteInfo({ collection, block, NOTION_CONFIG }) {
  ...
  const defaultPageCover = NOTION_CONFIG?.HOME_BANNER_IMAGE || 'https://img.ipoodle.top/file/isharehubs/1770190724936_banner.png'
